      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav navbar-right">
            <li class="<?php if($_SESSION['page']=="home"){ echo "active"; } ?>"><a href="main_page.php">Home</a></li>
            <li class="<?php if($_SESSION['page']=="new_action"){ echo "active"; } ?>  dropdown">
            ...
            <li class="<?php if($_SESSION['page']=="newly_received"){ echo "active"; } ?> dropdown">
            ...
            <li class="<?php if($_SESSION['page']=="ogm"){ echo "active"; } ?> dropdown">
			...
			?>
			<li class="<?php if($_SESSION['page']=="records_officer"){ echo "active"; } ?> dropdown">
